...
void motor(char motorno , char dir[20] , int speeds){
       ...
       /* *dport |=pwm | en | pulse;  //both the port are output
        *bport |=latch | data;
        *bout |= en;
        _delay_ms(1);*/
         *dport |=0xff;
...
//<<MOTOR 4>>//        
  ...
  /*  //MOTOR 1//  
        ...
        *dport=0xff;
        ...
        char *m_one=0xb3,*tccr0a=0xb0,**tccr0b=0xb1;
   ...
   //MOTOR 2//    
        ...
        *dport=0xff;
        ...
        char *m_two=0xb4,*tccr0a=0xb0,**tccr0b=0xb1;
   ...
   //MOTOR 3//    
     // if(motorno==3)
            ...
            *dport=0xff;
            ...
            char *m_three=0x47,*tccr0a_m3_m4=0x44,**tccr0b=0x45;
              int *tccr0a_m3=0x83;
            *tccr0a_m3_m4=0x00;
      ...
      if(motorno==4 || motorno==3) 
       {  
           *tccr0a_m3_m4 |=*tccr0a_m3 | *tccr0a_m4;
       }
